  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3237481229U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1658294588U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3612232891U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(19911971U);
    } else {
      return 0;
    }
  } else {
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1791707713U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(393361484U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3681282103U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2364614509U);
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(instanceChksum, "s3bpCv9o7LOO5fK5VE5GrwB") == 0) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "s3bpCv9o7LOO5fK5VE5GrwB") == 0) {
