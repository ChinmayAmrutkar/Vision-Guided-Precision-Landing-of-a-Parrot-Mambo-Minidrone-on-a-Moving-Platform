    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.DrawRectangle_lineWidth
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.DrawRectangle_color
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.X_Centroid_Value
                    section.data(1).logicalSrcIdx = 3;
                    section.data(1).dtTransOffset = 0;

                    ;% dexojrsdjj.Y_Centroid_Value
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.oj1bbchlzf
                    section.data(1).logicalSrcIdx = 9;
                    section.data(1).dtTransOffset = 0;

                    ;% ntrh2fpvwnc.lvrecrpgo1
                    section.data(2).logicalSrcIdx = 10;
                    section.data(2).dtTransOffset = 19200;

                    ;% ntrh2fpvwnc.gpdryrhhrv
            ...
            section.data(7)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.jz50miuw10
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 2;

                    ;% ntrh2fpvwnc.g0bpuek10y
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 6;

                    ;% ntrh2fpvwnc.obp11vwfnt
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 7;

                    ;% ntrh2fpvwnc.bsd1ggezbl
                    section.data(6).logicalSrcIdx = 5;
                    section.data(6).dtTransOffset = 8;

                    ;% ntrh2fpvwnc.brmruw0bwj
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(13)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.m0jdoprhah
                    section.data(1).logicalSrcIdx = 2;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.kr22ok0hah
                    section.data(2).logicalSrcIdx = 3;
                    section.data(2).dtTransOffset = 2;

                    ;% cjyyyt0pe2y.kxbvf51mno
                    section.data(3).logicalSrcIdx = 4;
                    section.data(3).dtTransOffset = 4;

                    ;% cjyyyt0pe2y.pucrssfssn
                    section.data(4).logicalSrcIdx = 5;
                    section.data(4).dtTransOffset = 6;

                    ;% cjyyyt0pe2y.dv0a521gaa
                    section.data(5).logicalSrcIdx = 6;
                    section.data(5).dtTransOffset = 8;

                    ;% cjyyyt0pe2y.oakrea30vx
                    section.data(6).logicalSrcIdx = 7;
                    section.data(6).dtTransOffset = 10;

                    ;% cjyyyt0pe2y.lz0ujcp4gg
                    section.data(7).logicalSrcIdx = 8;
                    section.data(7).dtTransOffset = 12;

                    ;% cjyyyt0pe2y.ctlvrlptto
                    section.data(8).logicalSrcIdx = 10;
                    section.data(8).dtTransOffset = 22;

                    ;% cjyyyt0pe2y.pj2joh31gv
                    section.data(9).logicalSrcIdx = 11;
                    section.data(9).dtTransOffset = 24;

                    ;% cjyyyt0pe2y.ge3zdy5b5z
                    section.data(10).logicalSrcIdx = 12;
                    section.data(10).dtTransOffset = 26;

                    ;% cjyyyt0pe2y.h10mqipllq
                    section.data(11).logicalSrcIdx = 13;
                    section.data(11).dtTransOffset = 28;

                    ;% cjyyyt0pe2y.l4uzdmaozl
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.ipee5zcbrs
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.ey0jpkwerr
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.ponnwrb30l
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.h310vwzyy1
    ...
    targMap.checksum0 = 1701269436;
    targMap.checksum1 = 2423514093;
    targMap.checksum2 = 1855183244;
    targMap.checksum3 = 896936165;
